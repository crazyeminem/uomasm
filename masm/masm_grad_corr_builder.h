...
#ifndef masm_grad_corr_builder_h_
#define masm_grad_corr_builder_h_
//:
// \file
// \author Tim Cootes
// \brief Builds a masm_grad_corr_model.

#include <masm/masm_point_finder_builder.h>

//: Builds model for a masm_grad_corr_finder.
//  For each example image, samples gradient over a region and normalises it.
//  Resulting model is set to the mean of these sampled gradient patches.
class masm_grad_corr_builder : public masm_point_finder_builder
{
 private:
  //: Width of template
  unsigned ni_;
 ...
 public:
  ...
  virtual ~masm_grad_corr_builder() {}
...
#endif // masm_grad_corr_builder_h_
