...
#ifndef masm_ncc_finder_h_
#define masm_ncc_finder_h_

//:
// \file
// \brief Search for point using normalised cross-correlation.
// \author Tim Cootes
...
//: Search for point using normalised cross-correlation.
//  Each is associated with a masm_point_finder_model containing the data.
class masm_ncc_finder : public masm_point_finder
{
protected:
  //: Model containing data for this finder
  const masm_ncc_finder_model* ncc_model_;
...
public:
  ...
  virtual masm_ncc_finder* clone() const;
