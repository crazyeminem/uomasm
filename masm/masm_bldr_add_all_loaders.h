...
#ifndef masm_bldr_add_all_loaders_h_
#define masm_bldr_add_all_loaders_h_

//: Add all binary loaders and factory objects available in masm/bldr
...
#endif // masm_bldr_add_all_loaders_h_
