...
#ifndef masm_region_pdf_finder_h_
#define masm_region_pdf_finder_h_
...
//: Search for point using the PDF of region around point.
//  Associated with a masm_region_pdf_model containing the data.
class masm_region_pdf_finder : public masm_point_finder
{
protected:
  //: Model containing data for this finder
  const masm_region_pdf_model* region_pdf_model_;
...
public:
  ...
  //: Destructor
  virtual ~masm_region_pdf_finder();
  ...
  virtual masm_region_pdf_finder* clone() const;
